...
export const episodeResponseSchema = z
  .object({
    id: z.number().int(),
    seriesId: z.number().int(),
...
export const userSeriesResponseSchema = z
  .object({
    userId: z.string(),
    seriesId: z.number().int(),
...
export const userEpisodeResponseSchema = z
  .object({
    userId: z.string(),
...
export const seriesGetResponseSchema = z
  .object({
  ...
  .meta({ id: "SeriesGetResponse" });

export const seriesImportPostResponseSchema = z
  .object({
    series: seriesResponseSchema,
    userSeries: userSeriesResponseSchema.nullable()
  })
  .meta({ id: "SeriesImportResponse" });

export const seriesImportPostSchema = z
  .object({
    tmdbId: z.number().int().min(1)
  })
  .meta({ id: "SeriesImportBody" });
...
export type SeriesResponse = z.output<typeof seriesResponseSchema>;
export type SeasonResponse = z.output<typeof seasonResponseSchema>;
export type EpisodeResponse = z.output<typeof episodeResponseSchema>;
export type UserSeriesResponse = z.output<typeof userSeriesResponseSchema>;
export type UserEpisodeResponse = z.output<typeof userEpisodeResponseSchema>;
export type SeriesGetResponse = z.output<typeof seriesGetResponseSchema>;
export type SeriesImportPostResponse = z.output<typeof seriesImportPostResponseSchema>;
