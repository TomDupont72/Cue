...
type RenameOrCamelCase<Key extends string, Rename extends RenameMap> = Key extends keyof Rename
  ? Rename[Key]
  : CamelCase<Key>;

export type CamelCaseKeys<T, Rename extends RenameMap = {}> =
...
export function camelCaseKeys<T, Rename extends RenameMap = {}>(
  value: T,
