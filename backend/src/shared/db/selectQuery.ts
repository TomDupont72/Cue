...
type SelectArg<TSelect> =
    | Field<TSelect>
    | Partial<Record<Field<TSelect>, string>>;

export class SelectQuery<TModel extends FindManyModel<TWhere, TSelect>, TSelect, TWhere, TRow, TResult = TRow> extends Query<TModel ,TWhere> {
